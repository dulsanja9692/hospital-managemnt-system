...
export const PublicDashboard = () => {
 ...
 >
 <div className="relative p-10 bg-card border border-primary/20  ">
 <Heart className="text-primary animate-pulse" size={64} />
 <p className="mt-4 text-[9px]  uppercase  text-primary/70 font-sans">
 Authenticating...
 </p>
 </div>
 </motion.div>
 ...
 <h1 className="text-2xl md:text-2xl font-poppins  text-foreground ">
 MediFlow<span className="text-primary">+</span>
 </h1>
 <p className="text-xl md:text-2xl text-muted-foreground ">
 Tech-driven <span className="text-foreground ">Compassionate Care</span>.
 </p>
 </div>
 </motion.div>
 ...
 <Card key={idx} className="bg-card  border-border/20  ">
 <CardContent className="p-10 space-y-5 flex flex-col items-center">
 <item.icon size={30} className="text-primary" />
 <h3 className="text-lg font-poppins  uppercase text-foreground">{item.title}</h3>
 ...
 <Button className="h-20 px-12  bg-primary text-base font-poppins  uppercase  group">
 Find Doctor <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform" />
 </Button>
 <Button variant="outline" onClick={() => navigate('/login')} className="h-20 px-12  text-base font-poppins  uppercase ">
 Staff Portal
 </Button>
 </motion.div>
 </motion.div>
 ...
 <p className="absolute bottom-6 text-[8px]  text-muted-foreground/10 uppercase  font-sans">
