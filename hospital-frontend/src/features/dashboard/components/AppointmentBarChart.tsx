  ...
  return (
    <Card className="rounded-3xl border border-border/40 bg-card/60 backdrop-blur-xl p-6 shadow-lg h-full">
      <div className="flex items-center gap-3 mb-6 text-left">
        ...
        <div>
          <h3 className="text-sm font-poppins font-bold text-foreground tracking-tight">Weekly Appointments</h3>
          <p className="text-[10px] font-sans text-muted-foreground uppercase tracking-widest mt-0.5">This week's schedule load</p>
        </div>
      </div>
