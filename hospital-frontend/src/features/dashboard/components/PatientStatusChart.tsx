...
export const PatientStatusChart = () => {
 ...
 <div>
 <h3 className="text-sm font-poppins  text-foreground ">Patient Status</h3>
 <p className="text-[10px] font-sans text-muted-foreground uppercase  mt-0.5">Current registry breakdown</p>
 </div>
 </div>
