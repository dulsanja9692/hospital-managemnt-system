    ...
    <div className="max-w-7xl mx-auto p-2 space-y-10 text-left animate-in fade-in duration-700 pb-20 font-sans antialiased">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <Button 
          ...
          className="flex items-center gap-3 text-primary/60 font-poppins font-black uppercase tracking-[0.3em] text-[10px] hover:text-primary transition-all group p-0 h-auto bg-transparent"
        >
        ...
        <div className="flex gap-4">
          ...
          <Button 
            ...
            className="h-12 px-8 border-primary/20 rounded-2xl text-primary font-poppins font-black uppercase tracking-widest text-[10px] hover:bg-primary/5 transition-all"
          >
          ...
          <Button 
            ...
            className="h-12 px-8 border-white/20 rounded-2xl text-muted-foreground font-poppins font-black uppercase tracking-widest text-[10px] hover:bg-primary/5 transition-all"
          >
          ...
          <Button 
            ...
            className="h-12 px-8 bg-primary text-white font-poppins font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all gap-2"
          >
            {isGenerating ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <Card className="lg:col-span-1 rounded-[3rem] border-white/20 bg-card/40 backdrop-blur-3xl shadow-2xl overflow-hidden relative group">
           ...
           <CardContent className="p-10 flex flex-col items-center relative z-10">
              <Avatar className="w-44 h-44 rounded-[2.5rem] border-4 border-background shadow-2xl mb-8 overflow-hidden">
              ...
              <h2 className="text-3xl font-poppins font-black text-foreground tracking-tighter text-center uppercase leading-none">{patient.name}</h2>
              <Badge variant="secondary" className="mt-4 px-4 py-1 text-[10px] font-poppins font-black text-primary tracking-[0.4em] bg-primary/10">PATIENT_REF: {patient.id}</Badge>
              <div className="mt-10 w-full pt-8 border-t border-primary/10 space-y-5 text-xs font-bold uppercase tracking-widest text-muted-foreground">
                <div className="flex justify-between"><span>Registry NIC</span><span className="text-foreground font-mono">{patient.nic}</span></div>
                <div className="flex justify-between"><span>Signal Status</span><div className="flex items-center gap-2"><div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" /><span className="text-green-600">Stable</span></div></div>
              </div>
           </CardContent>
        </Card>
        ...
        <div className="lg:col-span-2 space-y-8">
          <VitalsMonitor />
          <Card className="rounded-[3.5rem] border-white/20 bg-card/40 backdrop-blur-3xl p-10 relative overflow-hidden shadow-2xl border">
            <CardContent className="p-0 space-y-12">
              <div className="flex items-center justify-between border-b border-primary/10 pb-6">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-primary/10 rounded-xl text-primary"><Zap size={20} /></div>
                  <div className="text-left"><h3 className="text-xl font-poppins font-black text-foreground tracking-tighter uppercase">Patient Narrative</h3></div>
                </div>
                <Button onClick={() => setIsModalOpen(true)} className="h-10 rounded-full bg-primary text-white font-poppins font-black uppercase tracking-widest text-[10px] px-6"><Plus size={16} className="mr-2"/> New Visit Entry</Button>
              </div>
      ...
      <footer className="mt-12 pt-8 border-t border-primary/5 flex justify-between items-center opacity-40 text-[9px] font-bold uppercase tracking-[0.3em]">
