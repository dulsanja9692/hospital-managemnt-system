...
export const PatientList = () => {
 ...
 <div className="p-4 bg-primary  text-white  relative overflow-hidden group">
 ...
 <Button onClick={() => navigate('register')} className="h-14 px-8 bg-primary text-white font-poppins   hover:scale-105 active:scale-95  gap-3 transition-all">
 <UserPlus size={20} />
 ...
 <div className="py-20 text-center opacity-20 flex flex-col items-center border-2 border-dashed border-border ">
 <Database size={64} className="mb-4 text-muted-foreground" />
 <p className="font-poppins  uppercase  text-xs">No Care Records Found</p>
 </div>
 )}
 </div>
 </ScrollArea>

 <div className="pt-8 border-t border-border flex justify-between items-center opacity-30 font-sans">
 <p className="text-[9px]   uppercase">Confidential Staff Portal</p>
 <p className="text-[9px]   uppercase">Staff: ITBIN-2211-0249</p>
 </div>
 </div>
 );
};