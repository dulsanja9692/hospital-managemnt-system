...
export const AddAppointmentModal = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
 ...
 <DialogContent className="sm:max-w-lg  p-0 overflow-hidden border-border bg-card  text-left font-sans">
 ...
 <div>
 <DialogTitle className="text-xl  text-foreground  uppercase leading-none">Schedule Session</DialogTitle>
 <DialogDescription className="text-[9px]  text-muted-foreground uppercase  mt-2">
 ...
 <Label className="text-[10px]  uppercase text-muted-foreground  flex items-center gap-2 ml-1">
 ...
 <SelectContent position="popper" className="z-100  uppercase text-xs">
 ...
 className="w-full h-16 bg-primary text-white    hover:scale-[1.02] active:scale-95 transition-all gap-3 uppercase  text-[11px]"
 >
