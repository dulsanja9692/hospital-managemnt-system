 ...
 */}
 <DialogContent className="sm:max-w-2xl  p-0 overflow-hidden border-border bg-card  font-sans antialiased [&>button]:hidden">
 ...
 className="w-12 h-12  bg-white  border border-border text-white hover:bg-card transition-all"
 >
 ...
 size="icon"
 onClick={onClose} 
 className="w-12 h-12  bg-card  border border-border text-white hover:bg-red-500/60 transition-all group"
 >
 ...
 <div className="w-28 h-28 bg-background  border-4 border-card flex items-center justify-center text-primary shrink-0 overflow-hidden relative z-10">
 ...
 variant="outline"
 className={`mb-3 h-8 px-4  text-[10px] font-poppins  uppercase  transition-all gap-2 border ${
 ...
 className="h-14 text-xl font-poppins  bg-card border-primary/40  px-5 uppercase transition-all"
 />
 ) : (
 <DialogHeader>
 <DialogTitle className="text-2xl font-poppins  text-foreground  uppercase leading-none">
 {formData.name}
 </DialogTitle>
 </DialogHeader>
 )}
 ...
 <div className="p-5 bg-primary/5 border border-primary/10  text-lg font-poppins  text-primary ">
 ...
 <div className="p-5 bg-muted border border-border  text-lg font-poppins  text-foreground/70 uppercase ">
 {formData.dept}
 </div>
 </div>
 ...
 <div className="p-5 bg-muted border border-border  text-lg font-sans  text-foreground">
 ...
 {/* 4. EDITING ACTIONS */}
 {isEditing && (
 <div className="mt-12 pt-8 border-t border-border space-y-6 animate-in slide-in-from-bottom-4 font-poppins">
 <div className="flex flex-col sm:flex-row gap-4">
 <Button 
 variant="outline"
 onClick={() => onDelete && onDelete(formData.id)}
 className="h-14 px-8 border-red-500/20 text-red-500   hover:bg-red-500/10 gap-3 group transition-all"
 >
 ...
 <Button 
 onClick={handleSave} 
 className="flex-1 h-14 bg-primary text-white    hover:scale-[1.02] active:scale-95 transition-all gap-3 uppercase  text-[10px]"
 >
 ...
 className="px-8 h-14   hover:bg-muted active:scale-95 transition-all uppercase  text-[10px]"
 >
 Discard
 </Button>
 </div>
 ...
 <span className="text-[8px]  uppercase ">Biometric Authorization Verified</span>
 </div>
 </div>
 )}
 </div>
