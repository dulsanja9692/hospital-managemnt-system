...
export const Footer = () => {
  ...
  return (
    <footer className="w-full mt-auto py-10 transition-all duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 px-2">
        ...
        <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground/60">
          ...
          <p>
            © {year} <span className="text-primary/80">MediFlow</span> 
            <span className="ml-2 px-2 py-0.5 border border-border rounded-md bg-muted/30">HMS Registry</span>
          </p>
        </div>
        ...
        <div className="flex items-center gap-6 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/50">
          <button className="hover:text-primary hover:tracking-[0.3em] transition-all duration-300 cursor-help">
            Network Protocol Support
          </button>
          
          {/* Using Shadcn Badge for the versioning tag */}
          <Badge 
            variant="outline" 
            className="rounded-full px-4 py-1.5 border-primary/10 bg-primary/5 hover:bg-primary/10 transition-colors flex items-center gap-2 group"
          >
            {/* Live System Pulse */}
