...
export const DashboardLayout = ({ user }: LayoutProps) => {
 ...
 <p className="text-[10px]  uppercase  text-muted-foreground animate-pulse">
 ...
 */}
 ...
 className="absolute -right-5 top-12 z-50 h-10 w-10   border-4 border-background"
 >
 ...
 */}
 ...
 <div className="flex-1 bg-card/80 backdrop-blur-md  border border-white/40 dark:border-white/5 p-6 md:p-12  transition-all duration-500">
 <Outlet context={{ user }} /> 
 </div>
