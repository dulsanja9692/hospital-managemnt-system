    ...
    <>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            className="flex items-center gap-3 h-12 pl-1.5 pr-4 bg-card/50 border border-border/40 rounded-2xl hover:border-primary/50 hover:bg-primary/5 transition-all group focus-visible:ring-0"
          >
            <div
              className={`w-9 h-9 ${style.bg} ${style.text} rounded-xl flex items-center justify-center text-xs font-bold shadow-md transition-transform group-hover:scale-105 shrink-0`}
            >
              {initials}
            </div>
            ...
            <div className="text-left hidden sm:block">
              ...
              <span
                className={`inline-block mt-0.5 px-2 py-0.5 rounded-md text-[10px] font-semibold ${style.badge}`}
              >
                {userRole}
              </span>
            </div>
        ...
        <DropdownMenuContent align="end" className="w-60 mt-2 rounded-2xl border-border/40 bg-card/95 backdrop-blur-xl p-2 shadow-2xl">
          <div className="flex items-center gap-3 px-3 py-3 border-b border-border/40 mb-1">
            <div className={`w-10 h-10 ${style.bg} ${style.text} rounded-xl flex items-center justify-center text-sm font-bold shadow shrink-0`}>
              {initials}
            </div>
            <div>
              <p className="text-sm font-semibold text-foreground leading-tight">{userName}</p>
              <span className={`inline-block mt-0.5 px-2 py-0.5 rounded-md text-[10px] font-semibold ${style.badge}`}>
                {userRole}
              </span>
            </div>
          </div>
          ...
          <DropdownMenuItem 
            ...
            className="rounded-xl py-2.5 focus:bg-primary/10 focus:text-primary cursor-pointer transition-colors"
          >
          ...
          <DropdownMenuItem
            ...
            className="rounded-xl py-2.5 text-red-500 focus:bg-red-500/10 focus:text-red-600 cursor-pointer transition-colors font-semibold"
          >
